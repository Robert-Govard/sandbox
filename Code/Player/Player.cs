...
public sealed partial class Player : Component, Component.IDamageable, PlayerController.IEvents, Global.ISaveEvents, IKillSource
{
	...
	/// <summary>
	/// Clamp and save vertical FOV (used by console <c>fov</c> / <c>sb.fov</c>).
	/// </summary>
	public static float ApplyFovFromCommand( float degrees )
	{
		var v = degrees.Clamp( 54f, 120f );
		GamePreferences.FieldOfView = v;
		return v;
	}
